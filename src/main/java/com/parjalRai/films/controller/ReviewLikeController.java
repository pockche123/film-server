...
public class ReviewLikeController {
    ...
    @PostMapping
    public ResponseEntity<ReviewLike> createReviewLike(@RequestBody ReviewLikeDTO reviewLikeDTO) {
        try {
            ReviewLike reviewLike = reviewLikeService.createReviewLike(reviewLikeDTO.userId(),
                    reviewLikeDTO.reviewId());
                    System.err.println(reviewLike);
            return ResponseEntity.ok(reviewLike);
        } catch (Exception e) {
            System.err.println("user ID : " + reviewLikeDTO.userId());
            System.err.println( "review ID: " + reviewLikeDTO.reviewId());
